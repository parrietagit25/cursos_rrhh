      ...
      <?php // <form action="" method="post"> ?>
        <div class="container">
            ...
            <div class="container text-left" style="border: solid 1px #FADE24; padding:20px;">
              <div class="row">
                <?php if ($_GET['id_curso']==1) { ?>
                    <div class="col-12" style="border: solid 1px #FADE24; padding:20px;">
                        <iframe width="320" height="315" src="https://www.youtube.com/embed/hhi7JNOIOUY?si=-zHMEK623rxYZUuD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        <br>
                        <br>
                        <a href="pruebas.php?id_prueba=1">Hacer Prueba</a>
                    </div>
               <?php }elseif($_GET['id_curso']==2){ ?>
