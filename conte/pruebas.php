              ...
              <div class="row">
                <?php if ($_GET['id_prueba']==1) { ?>
                        <div class="col-12" style="border: solid 1px #FADE24; padding:20px;">
                            ...
                            <form name="miFormulario" action="#" method="post" onsubmit="return validarRadio('pre_1');">
                            ...
                            <form name="miFormulario" action="#" method="post" onsubmit="return validarRadio('pre_2');">
                            ...
                            <form name="miFormulario" action="#" method="post" onsubmit="return validarRadio('pre_3');">
                            ...
                            <form name="miFormulario" action="#" method="post" onsubmit="return validarRadio('pre_4');">
                            ...
                            <form name="miFormulario" action="#" method="post" onsubmit="return validarRadio('pre_5');">
